document.addEventListener('DOMContentLoaded', function() {
    ...
    const trainingIdForDelete = document.getElementById('trainingIdForDelete');
    ...
    document.querySelectorAll('.active-training').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            if (mode == 'view') {
                ...
                trainingIdForDelete.value = trainingId;
                trainingSelect.value = trainingName;

                const selectedProgram = trainingName;
                ...
                if (selectedProgram && trainersData[selectedProgram]) {
                    trainersData[selectedProgram].forEach(trainer => {
                        ...
                        option.classList.add('modal-window__option');
