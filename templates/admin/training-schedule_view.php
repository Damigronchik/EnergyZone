<section class="schedule">
    ...
    <div class="schedule__change">
        <a href="index.php?page=admin/training-schedule&mode=wishlist" class="schedule__change-button<?= $edited ? '' : ' schedule__change-button_disable' ?>">
    ...
    <span class="schedule__change-description">Это актуальное расписание на неделю. Расписание действует до конца текущего месяца.</span>
    <span class="schedule__change-description">Новое расписание составляется администратором с 14 по 15 число каждого месяца. До этого тренера составляют расписание в соответствии со своими пожеланиями.</span>
