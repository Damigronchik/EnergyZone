<section class="schedule">
    ...
    <div class="schedule__change">
        ...
        <p class="schedule__change-text">Расписание на <?= $monday->format('d.m') . '-' . (clone $monday)->modify('+6 days')->format('d.m') ?></p>
        <a href="index.php?page=training-schedule&mode=next" class="schedule__change-button">
            <img class="img-default" src="<?= IMG_PATH ?>round_arrow.png" alt="arrow">
            <img class="img-hover" src="<?= IMG_PATH ?>round_arrow_active.png" alt="arrow">
        </a>
    </div>
            ...
            for ($hour = 9; $hour < 22; $hour++) {
                ...
                for ($i = 1; $i < 8; $i++) {
                    ...
                    if ($training) {
                        ...
                        <td <?= $cell_class ?>>
                            <button type="button" 
                                    class="<?= $current_day->format('d.m.Y')<$now->format('d.m.Y') || $now_hour>$hour ? 'disable-training' : 'active-training' ?>"
